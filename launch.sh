...
if ! [[ -f 'Medieval+MC+[FORGE]+1.20.1+v24.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Medieval+MC+[FORGE]+1.20.1+v24.zip' 'https://www.curseforge.com/api/v1/mods/876851/files/4951593/download' || exit 9
	unzip -u -o 'Medieval+MC+[FORGE]+1.20.1+v24.zip' -d /data
